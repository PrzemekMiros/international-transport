...
$(function(){
  ...
  $('.cursel-center-img').delay(500).queue(function(){
  		$(this).addClass('load');
   });
  $('.cursel-center-tit h2').delay(800).queue(function(){
  		$(this).addClass('load');
   });
  $('#count').delay(1000).queue(function(){
  		$(this).addClass('load');
   });
  $('#logo,#job,nav,#cr').delay(800).queue(function(){
      $(this).addClass('load');
   });
  $('.cursel-up h2,.cursel-under h2').delay(1100).queue(function(){
      $(this).addClass('load');
   });
  $('.hover-delay').delay(1400).queue(function(){
      $(this).addClass('load');
   });
});
...
$(function() {
  ...
  var TITLES = [
    ['SYSTEM<br>ZAMÓWIEŃ', 'realizacja1.html'],
    ['WYPOŻYCZALNIA<br>SAMOCHODÓW', 'realizacja2.html'],
    ['KANCELARIA<br>ODSZKODOWAŃ', 'realizacja3.html'],
    ['PIZZERIA<br>BIANCA', 'realizacja4.html'],
    ['RETRO GRY<br>I KONSOLE', 'realizacja5.html'],
    ['CATERING SZYTY <br>NA MIARĘ', 'realizacja6.html'],



  ]
  var IMAGES = [
    ['systemefekt.jpg', 'system.jpg'],
    ['rentacarefekt.jpg', 'rentacar.jpg'],
    ['odszkodowaniaefekt.jpg', 'odszkodowania.jpg'],
    ['pizzeriaefekt.jpg', 'pizzeria.jpg'],
    ['retrogryefekt.jpg', 'retrogry.jpg'],
    ['gusto2efekt.jpg', 'gusto2.jpg'],
  ...
  setTimeout(setScrollEvents, 500)
})
