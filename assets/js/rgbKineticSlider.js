(function() {
    ...
    window.rgbKineticSlider = function(options) {
        ...
        options.googleFonts = options.hasOwnProperty('googleFonts') ? options.googleFonts : ['Montserrat:900'];
        options.buttonMode = options.hasOwnProperty('buttonMode') ? options.buttonMode : true;
        options.textTitleColor = options.hasOwnProperty('textTitleColor') ? options.textTitleColor : 'black'; 
        ...
        options.textSubTitleColor = options.hasOwnProperty('textSubTitleColor') ? options.textSubTitleColor : 'black'; 
